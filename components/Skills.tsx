...
const technologies = [
  {
    ...
    items: [
      {
        name: ".NET MAUI, WPF",
        description: "Cross-platform UI framework and native Windows apps",
        icon: Code,
        color: "from-orange-500/20 to-orange-600/20 text-orange-500",
      },
      {
        name: "Flutter",
        description: "Cross-platform mobile app development UIs",
        icon: Smartphone,
        color: "from-blue-500/20 to-blue-600/20 text-blue-500",
      },
      {
        name: "Svelte",
        description: "Reactive UI framework with a compiler",
        icon: Layers,
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "ASP.NET",
        description: "Framework for building web applications and services",
        icon: Server,
